...
For the estimation of individual protomer populations, the user needs to install CREST, xTB (with g-xTB 2.0), and CPCM-X with the respective binary or execution script added to path.
